  ...
  return (
    <div>
      <Disclaimer>
        ...
        <DisclaimerList>
          <DisclaimerListItem>
            This service is 100% free and our aim is to make it easier to manage
            relief distribution. More features will be added in coming days.
          </DisclaimerListItem>
          <DisclaimerListItem>
          ...
          <DisclaimerListItem>
            ...
            medicine etc. We facilitate the coordination between parties who can
            provide assistance and individuals or organizations in need of
            relief.
          </DisclaimerListItem>
          <DisclaimerListItem>
        ...
        <DisclaimerList>
          ...
          <DisclaimerListItem>
            මෙහි පද්ධතියේ අඩංගු තොරතුරු විවිධ පුද්ගලයින් සහ සංවිධානය විසින් එක්
            කර ඇති අතර ඒවායේ නිරවද්‍යතාව පරීක්ෂාකර බලා වගකීම් සහගතව ක්‍රියා කරන
            මෙන් අපි ඔබගෙන් කාරුණිකව ඉල්ලා සිටිමු.
          </DisclaimerListItem>
          <DisclaimerListItem>
            මෙම සේවාව කිසිදු අයුරකින් මුදල් එකතු කිරීම හෝ ආහාර, ඖෂධ වැනි දෑ එකතු
            කිරීම හෝ ගබඩා කිරීම සිදු නොකරයි. අප උපකාර සැපයිය හැකි පාර්ශව සහ
            උපකාර අවශ්‍ය පුද්ගලයින් හෝ සංවිධානය අතර සම්බන්ධීකරණය පමණක් සිදු
            කරන්නෙමු.
          </DisclaimerListItem>
          <DisclaimerListItem>
            මෙම වෙබ් සේවාව පවත්වාගෙන යාම ස්වේච්ඡා සේවවක් වන අතර මෙය ප්‍රජාව
            විසින් බලගැන්වෙන් ව්‍යාපෘතියකි. වැඩිදුර තොරතුරු ලබා ගැනීමට සහ සේවාව
            වැඩි දියුණු කිරීමට උදව් කිරීම සදහා GitHub පිටුවට සම්බන්ධ වෙන්න.
          </DisclaimerListItem>
        </DisclaimerList>
        ...
        <DisclaimerList>
          ...
          <DisclaimerListItem>
            ...
            வழங்கக்கூடிய தரப்பினருக்கும், நிவாரணம் தேவைப்படும் தனிநபர்கள் அல்லது
            நிறுவனங்களுக்கும் இடையே ஒருங்கிணைப்பை நாங்கள் எளிதாக்குகிறோம்.
          </DisclaimerListItem>
          <DisclaimerListItem>
